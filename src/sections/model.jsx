...
export const Model = () => {
  ...
  return (
    <section className='w-full overflow-x-hidden bg-[#010101]'>
      ...
      <div className='flex justify-center gap-4 pb-8'>
        <button className='bg-gray-200 text-black rounded-full px-5 py-2 hover:bg-slate-600 hover:text-white' onClick={()=>{setModelSize(20)}}>iphone 15</button>
        <button className='bg-gray-200 text-black rounded-full px-5 py-2 hover:bg-slate-600 hover:text-white' onClick={()=>{setModelSize(25)}}>iphone 15 PRO MAX</button>
      </div>
    </section>
  )
}
