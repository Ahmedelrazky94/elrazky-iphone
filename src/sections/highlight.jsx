...
export const Highlight = () => {
    ...
    useEffect(()=>{
        ...
        tl.to(".highlightvideo", { x: "0%", duration: 2 })
            ...
            .to(".highlightvideo", { x: "-100%", duration: 2 })
            .to(".highlightvideo", { duration: 0, delay: 2 })
            .to(".highlightvideo", { x: "-200%", duration: 2 })
            .to(".highlightvideo", {  duration: 0, delay: 4 })
            .to(".highlightvideo", { x: "-300%", duration: 2 })
